...
def main():
    ...
    runModel(runFlag = False, createEmbedsFlag=False, trainFlag = False, testFlag = False, weightsFile = "keras_150epochs_malstm_1000batchWeights_Adam_F1.h5", modelFile = "keras_150epochs_malstm_1000batch_Adam_F1.json",
    ...
    runModel(runFlag = True, createEmbedsFlag=False, trainFlag = False, testFlag = True, weightsFile = "2siamese2.h5", modelFile = "2siamese2.json",
    loss =  'mean_squared_logarithmic_error', metric = 'accuracy', optimizerUse='Adam', distanceFunc = 'exponent_neg_manhattan_distance', batch_size = 1000, n_epoch = 100,
    validationDataSize = 40000, n_hidden = 100, gradient_clipping_norm = 1.25)
