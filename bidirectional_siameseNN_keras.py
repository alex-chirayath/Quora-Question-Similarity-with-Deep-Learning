...
from keras.layers import Input, Embedding, LSTM, Merge, Dense, Concatenate, Bidirectional
...
def neuralNetworkModel(maxSentenceLen, embeddings, n_hidden, gradient_clipping_norm, optimizerUse, distanceFunc):
    ...
    siameseLstm = Bidirectional(LSTM(n_hidden, dropout=0.0, recurrent_dropout=0.05, return_sequences=False))
...
def runModel(runFlag, createEmbedsFlag,trainFlag,testFlag,weightsFile,modelFile,loss,metric,optimizerUse,distanceFunc,batch_size,n_epoch,validationDataSize,n_hidden,gradient_clipping_norm):
    if runFlag:
        ...
        trainModel(trainFlag, train_data, test_data, embeddings, questionHeader, weightsFile, modelFile, loss, metric, batch_size, n_epoch, validationDataSize, n_hidden, gradient_clipping_norm, optimizerUse, distanceFunc)
...
def main():
    ...
    runModel(runFlag = True, createEmbedsFlag=False, trainFlag = True, testFlag = False, weightsFile = "Bidirectionalkeras_150epochs_malstm_1000batchWeights_Adam_F1.h5", modelFile = "keras_150epochs_malstm_1000batch_Adam_F1.json",
    loss =  'mean_squared_logarithmic_error', metric = 'accuracy', optimizerUse='Adam', distanceFunc = 'exponent_neg_manhattan_distance', batch_size = 1000, n_epoch = 30,
    validationDataSize = 40000, n_hidden = 155, gradient_clipping_norm = 1.25) #winner model
    ...
    loss =  'mean_squared_logarithmic_error', metric = 'accuracy', optimizerUse='SGD', distanceFunc = 'cosine_distance', batch_size = 1000, n_epoch = 30,
    validationDataSize = 40000, n_hidden = 50, gradient_clipping_norm = 1.25)
